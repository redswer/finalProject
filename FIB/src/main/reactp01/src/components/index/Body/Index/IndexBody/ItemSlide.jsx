...
function SlideItemBestSeller() {
    ...
    const best_filter = productList.filter((book) => {
        return book.type == 'best';
    })

    const Slide_item = ({ image, title, price, product_code }) => {
        return (
    ...
    return (
        <div className="index_main_section">
            <div className="slide_item">
                {best_filter.map((product_data, index) => (
                    <Slide_item
                        key={index}
                        id={product_data.product_code}
