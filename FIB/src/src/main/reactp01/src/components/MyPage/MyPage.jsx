        ...
        <div className='MyPage d-flex'>
                ...
                <ul className='d-flex'>
                    ...
                    <li>
                        <Link to="/BookmarkPage">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-bag-heart" viewBox="0 0 16 16">
                    ...
                    <li>
                        <Link to="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-ticket" viewBox="0 0 16 16">
            ...
            <div>
                <ul className='d-flex'>
                    ...
                    <li>
                        <Link to="../CustomerServiceCategory/CustomerServiceMailInquires/CustomerServiceMailInquiresMyList">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-card-list" viewBox="0 0 16 16">
